...
struct TipsView: View {
    ...
    @State var tips: [Tip] = [
                    ...
                    Tip(id: 3, categoria: NSLocalizedString("Self Defense", comment: ""), titolo: NSLocalizedString("Stay Aware", comment: ""), corpo: NSLocalizedString("Avoid talking on the phone or wearing earphones when walking alone.", comment: "")),
                    ...
                    Tip(id: 10, categoria: NSLocalizedString("Walking Alone", comment: ""), titolo: NSLocalizedString("Avoid Suspicious Things", comment: ""), corpo: NSLocalizedString("Stick to well-lit, busy places. Avoid shortcuts through dark alleys or parks. Stay alert for anything that feels off.", comment: "")),
                    ...
                    Tip(id: 28, categoria: NSLocalizedString("Walking Alone", comment: ""), titolo: NSLocalizedString("Avoid Secluded Areas", comment: ""), corpo: NSLocalizedString("Avoid stopping in secluded areas, try to stay in crowded or surveilled areas, either by securities or with a lot of other people.", comment: "")),
                    ...
                    Tip(id: 37, categoria: NSLocalizedString("Children Safety", comment: ""), titolo: NSLocalizedString("Walk Together", comment: ""), corpo: NSLocalizedString("Initially walk the route with your child to familiarize them with it. Show them safe places to cross and potential hazards.", comment: "")),
                        ...
                        Tip(id: 40, categoria: NSLocalizedString("Children Safety", comment: ""), titolo: NSLocalizedString("Use Crosswalks", comment: ""), corpo: NSLocalizedString("Use pedestrian crossings and obey traffic signals, this will help you decrease the possibilities of an accident.", comment: "")),
                        ...
                        Tip(id: 48, categoria: NSLocalizedString("Children Safety", comment: ""), titolo: NSLocalizedString("Identify Safe Routes", comment: ""), corpo: NSLocalizedString("Choose routes that avoid isolated or poorly lit areas, busy roads without sidewalks, and other hazards.", comment: ""))
                    ]
