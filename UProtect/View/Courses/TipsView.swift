...
struct TipsView: View {
    ...
    @State var tips: [Tip] = [
                    ...
                    Tip(id: 27, categoria: NSLocalizedString("Walking Alone", comment: ""), titolo: NSLocalizedString("Make Intentional Turns", comment: ""), corpo: NSLocalizedString("Make intentional turns to confirm if the same vehicle is still behind you.", comment: "")),
