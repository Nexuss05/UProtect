    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Section(header: Text(NSLocalizedString("Essential Safety Tips", comment: "")).font(.title3).fontWeight(.bold).foregroundColor(CustomColor.redBackground)) {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Section(header: Text(NSLocalizedString("Preventive Measures", comment: "")).font(.title3).foregroundStyle(CustomColor.redBackground).bold()) {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Section(header: Text(NSLocalizedString("On Foot:", comment: "")).font(.title2).bold()) {
                ...
                Section(header: Text(NSLocalizedString("In a Vehicle:", comment: "")).font(.title2).bold()) {
                ...
                Section(header: Text(NSLocalizedString("Using Public Transport:", comment: "")).font(.title2).bold()) {
...
struct Course205: View {
    ...
    private func question1Options(_ index: Int) -> String {
        switch index {
        case 1: return NSLocalizedString("A. Plan your route and share it with someone you trust.", comment: "")
                case 2: return NSLocalizedString("B. Carry your phone and use it for messages or music.", comment: "")
                case 3: return NSLocalizedString("C. Walk through dark alleys or parks for shortcuts.", comment: "")
                case 4: return NSLocalizedString("D. Avoid sharing your travel plan with anyone.", comment: "")
                default: return ""
        }
    }
    ...
    private func question2Options(_ index: Int) -> String {
        switch index {
        case 1: return NSLocalizedString("A. Stay alert and aware of surroundings.", comment: "")
                case 2: return NSLocalizedString("B. Use reflective surfaces to check for followers.", comment: "")
                case 3: return NSLocalizedString("C. Alter your walking pattern.", comment: "")
                case 4: return NSLocalizedString("D. Carry a loud alarm.", comment: "")
                default: return ""
        }
    }
    ...
    private func question3Options(_ index: Int) -> String {
        switch index {
        case 1: return NSLocalizedString("A. Call the police immediately.", comment: "")
                case 2: return NSLocalizedString("B. Go to a public, well-lit, crowded place.", comment: "")
                case 3: return NSLocalizedString("C. Make intentional turns to confirm if followed.", comment: "")
                case 4: return NSLocalizedString("D. Continue walking and ignore the feeling.", comment: "")
                default: return ""
        }
    }
    ...
    private func resultText1() -> String {
            if selectedAnswer1 == 1 {
                return NSLocalizedString("Correct! Planning your route and sharing it with someone you trust enhances safety.", comment: "")
            } else {
                return NSLocalizedString("Incorrect. Planning your route and sharing it with someone you trust enhances safety.", comment: "")
            }
        }
    
    private func resultText2() -> String {
            if selectedAnswer2 == 1 {
                return NSLocalizedString("Correct! Staying alert and aware of surroundings helps detect if you're being followed.", comment: "")
            } else {
                return NSLocalizedString("Incorrect. Staying alert and aware of surroundings helps detect if you're being followed.", comment: "")
            }
        }
    
    private func resultText3() -> String {
            if selectedAnswer3 == 2 {
                return NSLocalizedString("Correct! Going to a public, well-lit, crowded place if you suspect you're being followed is a recommended action.", comment: "")
            } else {
                return NSLocalizedString("Incorrect. Going to a public, well-lit, crowded place if you suspect you're being followed is a recommended action.", comment: "")
            }
        }
    }
